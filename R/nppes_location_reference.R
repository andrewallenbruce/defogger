...
#'
#' @description Reference table of valid values for states and countries,
...
#'   \item{state_region}{State's region, from base r states dataset}
#'   \item{state_division}{State's division, from base r states dataset}
#'   ...
#' }
